...
def main(args):
    ...
    csvFile = os.path.join(folder, "identifiers_v2.csv")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--infos", type=str, help="all patient infos file",
                        required=False, default="/home/cougarnet.uh.edu/pyuan2/Projects/Incidental_Lung/data/Copy of SLN Data 11.05.2020.CFE.xlsx")
